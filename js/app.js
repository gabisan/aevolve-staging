...
.config(['cfpLoadingBarProvider', '$httpProvider', 'IdleProvider', 'KeepaliveProvider', function(cfpLoadingBarProvider, $httpProvider, IdleProvider, KeepaliveProvider) {
  ...
  // });
	...
	// configure Idle temporary settings
  IdleProvider.idle(5);
...
.run(['$rootScope', '$state', '$stateParams', '$transitions', '$location', 'Idle', function($rootScope, $state, $stateParams, $transitions, $location, Idle) {
